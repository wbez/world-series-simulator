...
```
cd world-series-simulator
mkvirtualenv world-series-simulator
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=19TGcqDB711DbJFYIASrPNaMVTJNCg3d3WuAauP7qrWM#gid=0).
...
def read_my_google_doc():
    ...
    get_document('19TGcqDB711DbJFYIASrPNaMVTJNCg3d3WuAauP7qrWM', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/world_series_simulator/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|world-series-simulator|tweet|`location`||
|world-series-simulator|facebook|`location`||
|world-series-simulator|email|`location`||
|world-series-simulator|new-comment||
|world-series-simulator|open-share-discuss||
|world-series-simulator|close-share-discuss||
|world-series-simulator|summary-copied||
|world-series-simulator|featured-tweet-action|`action`|
|world-series-simulator|featured-facebook-action|`action`|
