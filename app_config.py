...
PROJECT_SLUG = 'world-series-simulator'

# Project name to be used in file paths
PROJECT_FILENAME = 'world_series_simulator'

# The name of the repository containing the source
REPOSITORY_NAME = 'world-series-simulator'
...
ASSETS_SLUG = 'world-series-simulator'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '19TGcqDB711DbJFYIASrPNaMVTJNCg3d3WuAauP7qrWM'
